        ...
        <div class="w-4/5 mx-auto">
            ...
            <div class="flex items-center justify-between space-x-3 mb-5">
                ...
                <div class="w-1/4">
                    ...
                    class="px-5 py-2 rounded-full bg-white text-black font-bold hover:bg-yellow-200 block text-center">
                        Full Proxy Settings
                    </a>
                </div>
                <div class="w-1/4">
                    @if (session('full_proxy_mode') == true)
                        ...
                        class="px-5 py-2 rounded-full bg-black text-lime-300 font-bold hover:bg-gray-800 hover:text-white block text-center">
